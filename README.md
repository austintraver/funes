...
Code, Codex, Copilot CLI, pi, Hermes, and VS Code and lets any agent recall the past decisions, rationale, and findings.
...
- **One memory across your agents.** Index Claude Code, Codex, Copilot CLI, pi, Hermes, and VS Code into a single memory;
...
Your memory isn't tied to one tool. Because Claude Code, Codex, Copilot CLI, pi, Hermes, and VS Code all index into a single
