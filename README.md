...
Code, Codex, pi, Hermes, and Copilot CLI and lets any agent recall the past decisions, rationale, and findings.
...
- **One memory across your agents.** Index Claude Code, Codex, pi, Hermes, and Copilot CLI into a single memory;
...
Your memory isn't tied to one tool. Because Claude Code, Codex, pi, Hermes, and Copilot CLI all index into a single
